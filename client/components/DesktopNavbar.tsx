...
const DesktopNavbar = () => {
  return (
    <div
      className={"hidden sm:flex w-16 h-full bg-spotify-white/25 rounded-bl-lg border-t border-spotify-white/20 text-spotify-text/50 text-4xl flex-col items-center justify-even/50 px-0".concat()}
    >
      <NavbarLinkButton
        to="/"
